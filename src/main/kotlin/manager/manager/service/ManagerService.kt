...
class ManagerService
    ...
    @Transactional
    override fun createSnippet(input: CreateSnippet, userId: String, token: String): SnippetDto {
    ...
    private fun addOwnerPermission(userId: String, snippetId: Long, token: String) {
        val addPermDto = AddPermDto(
    ...
    override fun getSnippetDescriptors(userId: String, token: String): SnippetListDto {
    ...
    private fun getSnippetThatIOwn(user: UserSnippet): SnippetListDto =
        SnippetListDto(user.snippet.map { snippet: Snippet ->
    ...
    private fun getSnippetsShared(userId: String, token: String): SnippetListDto {
        val snippetIds = this.snippetPerm.getSharedSnippets(userId, token)
        return SnippetListDto(snippetIds.map { id: Long ->
    ...
    override fun getUserFriends(userId: String): UsersDto {
        ...
        val userDtoList = users.filter { user -> user.userId != userId }
    ...
    override fun shareSnippet(userId: String, shareSnippet: ShareSnippetInput, token: String): SnippetDto {
