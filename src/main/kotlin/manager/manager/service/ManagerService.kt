...
import manager.manager.repository.SnippetStatusByUserRepository
...
class ManagerService
    ...
    constructor(
        ...
        private val snippetStatusByUserRepository: SnippetStatusByUserRepository,
    ) : ManagerServiceSpec {
        @Transactional
        ...
        override fun updateSnippet(
            ...
            val status = this.updateSnippetStatus(userId, snippetId, ComplianceSnippet.PENDING)
            return SnippetDto(
                id = snippet.get().id!!,
                name = snippet.get().name,
                content = input.content,
        ...
        override fun updateSnippetStatus(
            ...
            val snippetCompliance = this.snippetStatusByUserRepository.updateSnippetForUser(userId, snippetId)
            val snippetStatusByUser = SnippetStatusByUser(userId, snippetCompliance, snippet.get())
            this.snippetStatusByUserRepository.save(snippetStatusByUser)
            return snippetCompliance
        }
