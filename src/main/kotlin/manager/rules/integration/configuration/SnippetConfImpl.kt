...
class SnippetConfImpl(
    ...
    override fun getSnippetId(token: String, testCaseId: String): String? {
    ...
    override fun postTestCase(token: String, testCaseInput: TestCaseInput): TestCaseDto {
    ...
    override fun deleteTestCase(token: String, testCaseId: String): String {
    ...
    private fun getJsonTestCase(testCaseInput: TestCaseInput): String {
        ...
        if(testCaseInput.input.isNullOrEmpty()) json.add("input", getJsonArray(emptyList()))
        else json.add("input", getJsonArray(testCaseInput.input))

        if(testCaseInput.output.isNullOrEmpty()) json.add("input", getJsonArray(emptyList()))
        else json.add("output", getJsonArray(testCaseInput.output))
